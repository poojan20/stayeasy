            ...
            <div class="col-12 mb-5 px-4">
                <div class="bg-white p-3 p-md-4 rounded shadow-sm">
                    <form id="info-form">
                        ...
                        <button type = "submit" class="btn btext-white custom-ng shadow-none">
                            Save Changes
                        </button>
            ...
            <div class="col-md-4 mb-5 px-4">
                <div class="bg-white p-3 p-md-4 rounded shadow-sm">
                    <form id="profile-form">
                        ...
                        <img src="<?php echo USERS_IMG_PATH.$u_fetch['profile'] ?>" class=" img-fluid mb-2"><!--rounded-circle-->
                       
                        <label  class="form-label">New Picture</label>
                        <input type="file" name="profile" accept=".jpeg" class="form-control shadow-none mb-4" required>
