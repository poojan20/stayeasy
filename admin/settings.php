        ...
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                        ...
                        <form action="">
                            <div class="modal-content">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name = "siteTitleElement" id ="site_title_inp" class="form-control shadow-none">
                                 </div>
                                 <div class="mb-3">
                                    <label class="form-label">About Us</label>
                                    <textarea name="siteAboutElement" id ="site_about_inp" class="form-control shadow-none"  rows="5"></textarea>
                                </div>
                                </div>
                                <div class="modal-footer">
                                    ...
                                    <button type="button" onclick ="upd_general(siteTitleElement.value , siteAboutElement.value)" class="btn  shadow-none">Save</button>
                                </div>
            ...
            <div class="card border-0 shadow-sm">
               <div class="card-body">
                    ...
                    <p class="card-text">
                        No customer will be allowed to book hotel room,whne shutdown mode is turned on.
                    </p>
                </div>
            </div>
        </div>
